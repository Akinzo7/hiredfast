      ...
      <div className="w-full max-w-[420px] bg-card rounded-2xl border border-border shadow-sm p-8">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loadingProvider !== null}
            className="w-full flex items-center justify-center gap-3 h-11 px-4 rounded-xl bg-[#1877F2] hover:bg-[#166FE5] transition-colors text-sm font-medium text-white disabled:opacity-60 disabled:cursor-not-allowed"
          >
