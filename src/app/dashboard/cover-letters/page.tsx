      ...
      <div className="p-6 md:p-8 max-w-5xl">
        ...
        {loaded && letters.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center border-2 border-dashed rounded-2xl">
            ...
            <CoverLetterModal>
              <button className="mt-4 inline-flex items-center gap-2 h-9 px-4 rounded-lg bg-green-600 hover:bg-green-700 text-white text-sm font-medium transition-colors">
